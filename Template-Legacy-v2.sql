...
-- Listage de la structure de la base pour esxlegacy_7f729c
CREATE DATABASE IF NOT EXISTS `esxlegacy_7f729c` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `esxlegacy_7f729c`;

-- Listage de la structure de table esxlegacy_7f729c. addon_account
...
-- Listage des données de la table esxlegacy_7f729c.addon_account : ~8 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. addon_account_data
...
-- Listage des données de la table esxlegacy_7f729c.addon_account_data : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. addon_inventory
...
-- Listage des données de la table esxlegacy_7f729c.addon_inventory : ~5 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. addon_inventory_items
...
-- Listage des données de la table esxlegacy_7f729c.addon_inventory_items : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. banking
...
-- Listage des données de la table esxlegacy_7f729c.banking : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. billing
...
-- Listage des données de la table esxlegacy_7f729c.billing : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. cardealer_vehicles
...
-- Listage des données de la table esxlegacy_7f729c.cardealer_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. datastore
...
-- Listage des données de la table esxlegacy_7f729c.datastore : ~9 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. datastore_data
...
-- Listage des données de la table esxlegacy_7f729c.datastore_data : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. fine_types
...
-- Listage des données de la table esxlegacy_7f729c.fine_types : ~52 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. items
...
-- Listage des données de la table esxlegacy_7f729c.items : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. jobs
...
-- Listage des données de la table esxlegacy_7f729c.jobs : ~14 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. job_grades
...
-- Listage des données de la table esxlegacy_7f729c.job_grades : ~36 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. licenses
...
-- Listage des données de la table esxlegacy_7f729c.licenses : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. multicharacter_slots
...
-- Listage des données de la table esxlegacy_7f729c.multicharacter_slots : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. owned_vehicles
...
-- Listage des données de la table esxlegacy_7f729c.owned_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. ox_doorlock
...
-- Listage des données de la table esxlegacy_7f729c.ox_doorlock : ~11 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. rented_vehicles
...
-- Listage des données de la table esxlegacy_7f729c.rented_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. society_moneywash
...
-- Listage des données de la table esxlegacy_7f729c.society_moneywash : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. users
...
-- Listage des données de la table esxlegacy_7f729c.users : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. user_licenses
...
-- Listage des données de la table esxlegacy_7f729c.user_licenses : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. vehicles
...
-- Listage des données de la table esxlegacy_7f729c.vehicles : ~240 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. vehicle_categories
...
-- Listage des données de la table esxlegacy_7f729c.vehicle_categories : ~11 rows (environ)
...
-- Listage de la structure de table esxlegacy_7f729c. vehicle_sold
...
-- Listage des données de la table esxlegacy_7f729c.vehicle_sold : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_7f729c. whitelist
CREATE TABLE IF NOT EXISTS `whitelist` (
  `identifier` varchar(46) NOT NULL,
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Listage des données de la table esxlegacy_7f729c.whitelist : ~0 rows (environ)
